...
public class SQLQueries {
    ...
    public static final String REVOKE_ACCESS_TOKENS_IN_TENANT = "UPDATE IDN_OAUTH2_ACCESS_TOKEN SET TOKEN_STATE=?, " +
            "TOKEN_STATE_ID=? WHERE TENANT_ID=? AND TOKEN_STATE=?";

    public static final String REVOKE_ACCESS_TOKENS_IN_USER_STORE = "UPDATE IDN_OAUTH2_ACCESS_TOKEN SET " +
            "TOKEN_STATE=?, TOKEN_STATE_ID=? WHERE TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_STATE=?";
    ...
    public static final String REVOKE_AUTHORIZATION_CODES_IN_TENANT = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE SET " +
            "STATE=? WHERE TENANT_ID=? AND TOKEN_STATE=?";

    public static final String REVOKE_AUTHORIZATION_CODES_IN_USER_STORE = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE SET " +
            "STATE=? WHERE TENANT_ID=? AND USER_DOMAIN=? AND STATE=?";
